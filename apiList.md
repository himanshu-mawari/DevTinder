...
This document lists the available API endpoints and Socket.IO events for the DevTinder backend.
...
| GET    | `/user/:userId`           | Get public profile details of another user |
...
| `connectionRequestAccepted` | Notify a user when their connection request is accepted  |
| `connectionRequestReceived` | Notify a user when they receive a new connection request |
